...
<div id="container"> 
    <div class="menu_profil" align="center">
      ...
      if(isset($_SESSION['id']) AND $userinfo['id'] == $_SESSION['id']) //Quand on est connecter sur son profil
      {
       ...
       <br><br><br>
       <div class="chercher"><p>Chercher un utilisateur </p>
       </div>
    ...
    if(isset($_POST['q']) And !empty($_POST['q'])) {
     ...
     ?>         <?php if($profil_autre->rowCount() > 0 && $id_3 != $_SESSION['id']) { ?>
      ...
      <?php while($p = $profil_autre->fetch()) { ?>
        ...
        <p class="btn4 msg deja6">Profil <b><?= $p['pseudo'] ?></b> </font></p>
      ...
      <div class="text3">
        Pas d'utilisateur correspondant à<br>
        <strong>"<?= $q ?>"</strong> !
      </div>
    <?php  } ?> 
...
<br>
<div class="chercher"><p>Chercher un groupe</p>
</div>
  ...
  if(isset($_POST['grp']) AND !empty($_POST['grp'])) {
   ...
   $nom_grp = $all_grp['nom'];
       ...
       while($grp_1 = $grps->fetch()) { ?>
        ...
        <a class="deja6" href="groupes.php?id=<?= $id_grp ?>"><?= $nom_grp ?></a>
        
        <?php }
      } else { ?>
      <div class="text3">
        Pas de groupe correspondant à<br>
        <strong>"<?= $grp ?>"</strong> !
      </div>
    <?php  } ?>
   ...
   if($msg_nn_lu->rowCount() == 0) { ?>
    ...
    function load_box() {
     ...
     <div class="window" id="window" align="left">
       ...
       <a class="deja5 btn4" href="#"><p align="center">Discussion avec <?= $q ?></p></a>
...
<script>
  ...
  <form class="formu_pv" method="POST">
    <input style="margin-left: 9px; margin-top: 6px; width: 70%; " type="text" class="basic" name="message" id="msg1" placeholder="Votre message">&nbsp;
    <input type="submit" value="Envoyer" name="envoieMessage" style="width: 22%">
